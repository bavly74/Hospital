                              ...
                              <tr>
                                  ...
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        ...
                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete<?php echo e($doctor->id); ?>"><i   class="text-primary ti-key"></i>&nbsp;&nbsp;تغير كلمة المرور</a>
...
<?php echo $__env->make('Dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Bavly's Projects\hospital\resources\views/dashboard/doctors/index.blade.php ENDPATH**/ ?>