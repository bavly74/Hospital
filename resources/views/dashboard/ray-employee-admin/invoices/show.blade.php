    ...
    <div class="demo-gallery">
        <ul id="lightgallery" class="list-unstyled row row-sm pr-0">
            ...
            @foreach($rays->images as $image)
                ...
                <li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('dashboard/images/rays/'.$image->filename)}}" data-src="{{URL::asset('dashboard/images/rays/'.$image->filename)}}">
                    <a href="#">
                        <img width="50px" height="350px" class="img-responsive" src="{{URL::asset('dashboard/images/rays/'.$image->filename)}}" alt="NoImg">
                    </a>
                </li>
            @endforeach
        </ul>
