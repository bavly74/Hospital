                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td><a href="{{route('patient.index',['id'=>$invoice->patient_id])}}">{{ $invoice->Patient->name }}</a></td>
                                ...
                                @include('dashboard.doctor-admin.invoices.add_diagnostic')
                                @include('dashboard.doctor-admin.invoices.add_review')
                                @include('dashboard.doctor-admin.invoices.xray_converstion')
                                @include('dashboard.doctor-admin.invoices.lab_converstion')
