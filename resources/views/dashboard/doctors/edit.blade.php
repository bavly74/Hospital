...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('doctors.update')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div>
                                @if($doctor->image)
                                    <img style="border-radius:20%"
                                         src="{{Url::asset('dashboard/images/doctors/'.$doctor->image->filename)}}"
                                         height="150px" width="150px" alt="">
                                @else
                                    <img style="border-radius:50%"
                                         src="{{Url::asset('dashboard/images/doctor_default.png')}}"
                                         height="50px"
                                         width="50px" alt="">
                                @endif
                            </div>
