    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-lg-4 col-md-4 col-xm-12">
            <div class="overflow-hidden card sales-card bg-primary-gradient">
                <div class="pt-0 pt-3 pb-2 pl-3 pr-3">
                    <div class="">
                        <h6 class="mb-3 text-white tx-12">عدد الاطباء</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="mb-1 text-white tx-20 font-weight-bold">{{App\Models\Doctor::count()}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4  col-xm-12">
            <div class="overflow-hidden card sales-card bg-danger-gradient">
                <div class="pt-0 pt-3 pb-2 pl-3 pr-3">
                    <div class="">
                        <h6 class="mb-3 text-white tx-12">عدد المرضي</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="mb-1 text-white tx-20 font-weight-bold">{{App\Models\Patient::count()}}</h4>
                            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4  col-xm-12">
            <div class="overflow-hidden card sales-card bg-success-gradient">
                <div class="pt-0 pt-3 pb-2 pl-3 pr-3">
                    <div class="">
                        <h6 class="mb-3 text-white tx-12">عدد الموظفين</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="mb-1 text-white tx-20 font-weight-bold">{{App\Models\RayEmployee::count() + App\Models\LabEmployee::count()}}</h4>
                            </div>
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="pb-1 card-header">
                    ...
                    <p class="mb-0 tx-12 text-muted">Sales activities are the tactics that salespeople use to achieve
                ...
                <div class="pt-2 mt-1 product-timeline card-body">
                    <ul class="mb-0 timeline-1">
                        ...
                        <li class="mt-0 mb-0"><i
                                class="text-white icon-note icons bg-primary-gradient product-icon"></i> <span
                                class="mb-4 font-weight-semibold tx-14 ">Customer Reviews</span> <a href="#"
                                                                                                    class="float-left tx-11 text-muted">1
                                day ago</a>
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="pb-0 card-header">
                    ...
                    <p class="mb-0 tx-12 text-muted">An order is an investor's instructions to a broker or brokerage
